...
# 先把数据导入并处理好格式
avg_df_2 = pd.read_csv(f"D:/BCBM_by_ML/GSE125989_expr.csv")
...
X = scaler.fit_transform(gene_exp)
# print(X)

from sklearn.cluster import KMeans
kmeans = KMeans(n_clusters=4, random_state=0)
labels = kmeans.fit_predict(gene_exp.T)
# print(labels)
...
# 样本间的差异表达分析
### --------------------------------------------------------------
# 因为差异表达分析要使用r包，所以我们需要加载r和python之间的桥梁rpy2
import matplotlib.pyplot as plt
import rpy2
