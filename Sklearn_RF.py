...
# 读入数据
brain_8gene = pd.read_csv(f"D:/Desktop/BCBM_by_ML/file_input/brain_73_8gene.csv")
metadata = pd.read_csv(f"D:/Desktop/BCBM_by_ML/file_input/sample_metadata_73.csv")
